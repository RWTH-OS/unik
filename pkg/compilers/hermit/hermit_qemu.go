...
type HermitQemuCompiler struct{
	CompilerType string
}

func (i *HermitQemuCompiler) CompileRawImage(params types.CompileImageParams) (*types.RawImage, error) {
...
func (i *HermitQemuCompiler) findFirstImageFile(directory string) (string, error) {
...
func (r *HermitQemuCompiler) Usage() *compilers.CompilerUsage {
	return nil
}
